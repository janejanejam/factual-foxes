...
const svgContent = document.querySelector('#content')
...
function pageTransitionIn() {
  ...
  //       .to('ul.loading-transition li', { duration: .5, scaleY: 1, transformOrigin: "bottom left", stagger: .2})
  //       .to('ul.loading-transition li', { duration: .5, scaleY: 0, transformOrigin: "bottom left", stagger: .2})
...
function contentAnimation(container) {
  ...
  return gsap
    ...
    .add(svgContent)
    // .from(svgContent, { duration: .5, opacity: 0})
